...
<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/1999/xhtml"
    ...
    <xsl:template match="results">
        ...
        <br/>
         <div class="CollapsiblePanelTab" tabindex="0">Contract Header Details</div>
                
                 <div class="CollapsiblePanelContent">
                    <table width="100%" border="1">
                        <tr>
                        <td><b>ServiceContractInvoiceNumber</b></td>
                        <td><b>ContractNumber</b></td>
                            <td><b>CurrencyCode</b></td>
                            <td><b>ContractType</b></td>
                            <td><b>ContractStartDate</b></td>
        ...
        <br/>
                <div class="CollapsiblePanelTab" tabindex="0">Contract LINE Details</div>
                <div class="CollapsiblePanelContent">
                    <table width="100%" border="1">
                        <tr>
