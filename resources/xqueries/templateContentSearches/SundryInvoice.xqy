module namespace SundryInvoice = 'SundryInvoice';
...
declare function SundryInvoice:mainQuery($Company,$Branch,$Invoice,$restrictions,$first,$last,$currentuser){
	let $import := "import module namespace utility = 'utility' at '/APPLICATIONS/JBA/resources/xqueries/commonModules/utility.xqy';"


	let $for 	:= " for $elem in doc('/DATA/JBA/Collection/SSP45')/SSP45/SSP45-ROW[RECT45='IN'][INVT45='S']"
